        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <div className='text-center font-meidum'>
                    ...
                    <p className='py-2 border-b mx-8'>Showcase of React Cards Component</p>
                </div>
                <button className='bg-[#00df9a] w-[200px] rounded-md font-medium text-black my-6 mx-auto px-6 py-3'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
                ...
                <div className='text-center font-meidum'>
                    <p className='py-2 border-b mx-8 mt-8'>2 TB</p>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <div className='text-center font-meidum'>
                    <p className='py-2 border-b mx-8 mt-8'>10 TB</p>
